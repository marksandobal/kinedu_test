...
RSpec.describe Api::V1::UsersController, type: :request do
  ...
  describe 'GET #show' do
    ...
    it 'return error' do
      ...
      get "/users/#{id}", params: {}, headers: headers
  ...
  describe 'PUT #update' do
    ...
    context 'with valid data' do
      ...
      it 'responds with http status ok' do
        put "/users/#{user.id}", params: params, headers: headers
        expect(response).to have_http_status(:ok)
      end
      ...
      it 'responds with update fields' do
        expect { put "/users/#{user.id}", params: params, headers: headers }.to change { user.reload.last_name }
      end
    end
    ...
    context 'with invalid data' do
      ...
      it 'responds with http status not found' do
        id = Faker::Number.number(digits: 3)
        put "/users/#{id}", params: params, headers: headers
